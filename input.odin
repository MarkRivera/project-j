...
Input_Set :: bit_set[Input; u8]

Input_Vectors :: [Input] raylib.KeyboardKey {
...
process_input :: proc() -> Input_Set {
    fmt.println("Processing input...")
    
    fmt.println("Reading input state...")
    input_state : Input_Set = read_input()
...
socd_input :: proc(input_state : ^Input_Set) {
